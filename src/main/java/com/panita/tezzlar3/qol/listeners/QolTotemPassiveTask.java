    ...
    public void run() {
        for (Player player : Bukkit.getOnlinePlayers()) {
            ...
            if (CustomItemManager.isCustomItem(offHand, "axolotl_totem")) {
                player.addPotionEffect(new PotionEffect(PotionEffectType.REGENERATION, 60, 0, false, true, true));
            } else if (CustomItemManager.isCustomItem(offHand, "sulfur_totem")) {
                // Requires longer duration to avoid night vision blind flashing
                player.addPotionEffect(new PotionEffect(PotionEffectType.NIGHT_VISION, 400, 0, false, true, true));
            } else if (CustomItemManager.isCustomItem(offHand, "tadpole_totem")) {
                player.addPotionEffect(new PotionEffect(PotionEffectType.JUMP_BOOST, 60, 0, false, true, true));
                ...
                player.addPotionEffect(new PotionEffect(PotionEffectType.DOLPHINS_GRACE, 60, 0, false, true, true));
            } else if (CustomItemManager.isCustomItem(offHand, "sniffer_totem")) {
                player.addPotionEffect(new PotionEffect(PotionEffectType.HASTE, 60, 0, false, true, true));
