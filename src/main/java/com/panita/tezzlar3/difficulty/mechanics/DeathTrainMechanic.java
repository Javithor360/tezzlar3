...
public class DeathTrainMechanic extends DifficultyMechanic implements Listener, ActionBarProvider {
    ...
    public void setRemainingSeconds(int remainingSeconds) {
        this.remainingSeconds = Math.min(remainingSeconds, 172800); // Max 48 hours
    ...
    public void addDeathTrainTime(Player deceased, int secondsToAdd) {
        if (!isActive()) return;

        this.remainingSeconds += secondsToAdd;
        this.remainingSeconds = Math.min(this.remainingSeconds, 172800); // Max 48 hours
